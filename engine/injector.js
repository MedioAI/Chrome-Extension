    ...
    .medioCommand {color: ${await engine.getSettings("commandcolor")}}</style>
      ...
      <button class="medioChatDelete" data-id="${
        chat.id
          ...
          searchBox.addEventListener("input", (e) => {
            ...
            if (search === "") {
              container.innerHTML = "";
              const firstChats = chats.slice(0, engine.perPage);
      ...
      <button class="medioChatDelete" data-id="${
        chat.id
              ...
              document
                .querySelector("#medioPageCount")
                .setAttribute("data-max", chats.length);
              document.querySelector(
                "#medioPageCount"
              ).innerHTML = `Page 1 of ${chats.length}`;
            ...
            const filteredChats = chats.filter((chat) => {
              if (chat.name) {
                return (
                  ...
                  chat.song_title.toLowerCase().includes(search)
                );
              } else {
