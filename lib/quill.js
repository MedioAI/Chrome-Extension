    ...
    var t = {
              ...
              this.quill.keyboard.addBinding({
                ...
                handler(t, e) {
                  ...
                  return (
                    ...
                    (this.quill.setSelection(t.index - 1, t.length + (i.shiftKey ? 1 : 0), r.Ay.sources.USER),
                    !1)
                  )
                },
              })
        ...
        6142: function (t, e, n) {
                    ...
                    if (null != n.insert) {
                      if ((l.retain(o), 'string' == typeof n.insert)) {
                        ...
                        if (l) (e <= t || this.scroll.descendant(c.zo, t)[0]) && (h = !0)
                          ...
                          e instanceof d.A
                            ? '\n' !== e.value()[n] && (u = !0)
                            : e instanceof i.EmbedBlot && e.statics.scope === i.Scope.INLINE_BLOT && (u = !0)
                        }
          ...
          class I {
            ...
            deleteText(t, e, n) {
              return (
                ([t, e, , n] = P(t, e, n)), D.call(this, () => this.editor.deleteText(t, e), n, t, -1 * e)
              )
            }
            disable() {
              this.enable(!1)
            ...
            scrollRectIntoView(t) {
              ;((t, e) => {
                ...
                for (; i; ) {
                  ...
                  i =
                    t || 'fixed' === o.position ? null : (s = i).parentElement || s.getRootNode().host || null
                }
                var s
              })(this.root, t)
            }
          ...
          function z(t, e, n, r) {
            ...
            return (
              e && 'function' == typeof e.transformPosition
                ...
                : ([s, o] = [t.index, t.index + t.length].map(t =>
                    t < e || (t === e && r === N.A.sources.USER) ? t : i >= 0 ? t + i : Math.max(e, t + i)
                  )),
              new f.Q(s, o - s)
            )
          }
        ...
        584: function (t, e, n) {
                  ...
                  (t => {
                    ...
                    for (; s.length; ) {
                      ...
                      for (; e; )
                        t.push(e),
                          (e =
                            s.length && s[0]?.element === e.element.nextElementSibling && s[0].id === e.id
                              ? s.shift()
                              : null)
          ...
          const q = (0, l.A)('quill:clipboard'),
            k = [
                ...
                function (t, e, n) {
                  ...
                  if (!R(t)) {
                    ...
                    ;(r = r.replace(/\r\n/g, ' ').replace(/\n/g, ' ')),
                      ...
                      ((null == t.previousSibling && null != t.parentElement && j(t.parentElement, n)) ||
                        (t.previousSibling instanceof Element && j(t.previousSibling, n))) &&
                        (r = r.replace(/^\s+/, i.bind(i, !1))),
                      ((null == t.nextSibling && null != t.parentElement && j(t.parentElement, n)) ||
              ...
              [
                ...
                function (t, e, n) {
                  const r =
                    'TABLE' === t.parentElement?.tagName ? t.parentElement : t.parentElement?.parentElement
          ...
          function R(t) {
            return (
              null != t &&
              (C.has(t) || ('PRE' === t.tagName ? C.set(t, !0) : C.set(t, R(t.parentNode))), C.get(t))
            )
          }
                  ...
                  for (var f = i - o, p = f % 2 != 0, g = 0, m = 0, b = 0, y = 0, v = 0; v < l; v++) {
                    for (var A = -v + g; A <= v - m; A += 2) {
                      for (
                        var x = a + A,
                          N =
                            (_ = A === -v || (A !== v && u[x - 1] < u[x + 1]) ? u[x + 1] : u[x - 1] + 1) - A;
                    ...
                    for (var E = -v + b; E <= v - y; E += 2) {
                      for (
                        var w,
                          q = a + E,
                          k =
                            (w = E === -v || (E !== v && h[q - 1] < h[q + 1]) ? h[q + 1] : h[q - 1] + 1) - E;
        ...
        4162: function (t, e, n) {
          ...
          function Gt(t) {
            return null != (e = t) && Vt(e.length) && !$t(e)
              ...
              : (function (t) {
                  if (((n = (e = t) && e.constructor), e !== (('function' == typeof n && n.prototype) || Z)))
                    return ct(t)
                  var e,
                    n,
                    r = []
                  ...
                  if (r.insert) e.delete(l.default.length(r))
                    ...
                    if ('object' == typeof r.retain && null !== r.retain) {
                      const i = t.slice(n, n + 1),
                        ...
                        f = h.getHandler(l)
                      return (
                        e.retain({ [l]: f.invert(c, d) }, o.default.invert(r.attributes, s.attributes)), n + 1
                      )
                    }
                  }
                  return n
          ...
          const h = class extends i {
            ...
            f = class {
              ...
              replaceWith(t, e) {
                ...
                return (
                  null != this.parent && (this.parent.insertBefore(n, this.next || void 0), this.remove()), n
                )
              }
              split(t, e) {
    ...
    return (
      (function () {
        ...
        class X extends D.EJ {
          ...
          optimize(t) {
            if (
              (super.optimize(t), null != this.parent && null != this.children.head && null != this.uiNode)
            ) {
          ...
          initListener() {
            this.quill.on(p.Ay.events.SCROLL_BLOT_MOUNT, t => {
              ...
              this.options.languages.forEach(t => {
                ...
                null == t.uiNode &&
                  (t.attachUI(e), t.children.head && (e.value = G.formats(t.children.head.domNode)))
            })
          }
          initTimer() {
            let t = null
          ...
          insertRow(t) {
            ...
            n.insertRow(s + t),
              ...
              t > 0
                ...
                : this.quill.setSelection(e.index + r.children.length, e.length, p.Ay.sources.SILENT)
          }
          insertRowAbove() {
            this.insertRow(0)
          }
          ...
          buildPickers(t, e) {
            ;(this.pickers = Array.from(t).map(t => {
              ...
              if (t.classList.contains('ql-background') || t.classList.contains('ql-color')) {
                ...
                return (
                  null == t.querySelector('option') && kt(t, At, 'background' === n ? '#ffffff' : '#000000'),
                  new ft(t, e[n])
                )
              }
              return (
